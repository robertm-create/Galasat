// ============================================================
// GalaSat v1.0 — trainingPoints architecture, 286-line build
//
// MEMORY TAG: GalaSat_v1.0_trainingPoints_286
// SOURCE: claude.ai chat "Comparing Galasat version codes for Google grant"
//         https://claude.ai/chat/e9f12859-5bfa-4312-843a-aef612ffc2b2
//         pasted attachment, 286 lines, 19.23 KB
// EXTRACTED: 2026-04-25
//
// LINEAGE NOTE: trainingPoints branch member. Almost identical body to the
// 274/259/311 siblings in the Seasonal flood zone chat, BUT this copy
// uses the larger Tano basin geometry [-3.20, 6.50, -2.00, 7.80] (matches
// 506 variant) and the 2026-01-01 to 2026-02-28 dry-season window
// (matches 311). Submitted in the "Comparing version codes for Google grant"
// chat as one of the comparison candidates for the Google.org submission.
//
...
// ── BASIN GEOMETRIES (Tano = larger [-3.20, 6.50, -2.00, 7.80]) ────────
