...
//
// MEMORY TAG: GalaSat_v3  | INTERNAL VERSION: v2 duplicate (one-day date slip)
// SOURCE: claude.ai project "Technical - Repository"
//         chat "SuperSat_V1 code tagging" (Apr 20, 2026)
//         pasted attachment, 140 lines, GEE filename "GalaSat_v3"
// EXTRACTED: 2026-04-25
//
// STATUS: DUPLICATE — flagged for discard.
// Per chat analysis (Turn 5): "This is identical code to GalaSat_v2 — same functions,
// same composites, same date ranges, same console outputs. The only difference is the
// s2_26 end date: 2026-03-08 vs 2026-03-09. One day delta. No architectural changes."
//
// The .82 kappa code submitted later in the chat (Turn 6) is byte-for-byte identical
// to this file — there is no kappa coefficient anywhere in this code, and the 82% /
// Kappa 0.733 figures belong to SuperSat_V2 (GalaSat v5.4), not this baseline.
//
// CONFIRMED CONSOLE OUTPUT (same as v2):
...
var s2_26 = compS2('2025-10-01', '2026-03-08');  // v3 marker (v2 has 2026-03-09)
